...
<div class="ep-container" on:mousedown={stopBubble} on:click={stopBubble} on:keydown={stopBubble}>
  <!-- Search -->
  ...
  {#if !searchQuery.trim()}
    <div class="ep-categories" role="tablist" tabindex="-1" on:mousedown|stopPropagation on:click|stopPropagation on:keydown|stopPropagation>
