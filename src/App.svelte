<script lang="ts">
  ...
  import { appStore, activeDocument, undo, redo, canUndo, canRedo, pushUndoIfNeeded, initUndoForDoc } from './stores/stores';
  import type { Document } from './stores/stores';
  import CommandPalette from './components/CommandPalette.svelte';
  import SearchPanel from './components/SearchPanel.svelte';
  import LiveEditor from './components/LiveEditor.svelte';
...
<main class="app-container">
  ...
  <div class="workspace">
    ...
    <section class="editor-pane" class:hidden-pane={viewMode === 'preview' || viewMode === 'live'} style="width: {viewMode === 'write' ? '100%' : `${sidebarWidth}%`}">
      ...
      <section class="live-pane">
        {#if currentDoc}
          <LiveEditor 
            ...
            onUpdate={(markdown) => appStore.updateDocumentContent(currentDoc.id, markdown)}
          />
        {:else}
          <div class="empty-state">
            <div class="empty-icon">
  ...
  <footer class="status-bar">
    ...
    <div class="status-right">
      <div class="status-group">
        ...
        <button class="status-icon-btn" class:active-accent={viewMode === 'live'} on:click={() => viewMode = 'live'} title="Live Mode (Experimental WYSIWYG)">
          <Zap size={14} />
        </button>
      </div>
